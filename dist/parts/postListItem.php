...
<a class="p-post p-post-more" href="<?php echo esc_url($cat_link); ?>">
    <div class="p-post__inner">
        <div class="p-post__thumbnail">
            <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumbnail-item-s.webp" type="image/webp"/></source>
                <img class="p-post__image lazyload" data-src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumbnail-item-s.jpg" width="350px" height="300px" alt="more-post-thumbnail" />
            </picture>                        
        </div>
        <div class="p-post__body">
            <h2 class="p-post__title">アイテムに関する記事をさらに見る。</h2>
            <div class="p-post__meta">
                <p class="p-post__category">Item</p>
